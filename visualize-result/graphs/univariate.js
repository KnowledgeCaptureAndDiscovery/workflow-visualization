...
for(var ix in plotTypes) {
	Dashboard.loadScriptSync("graphs/univariate/" + plotTypes[ix].replace("-","") + ".js", checkLoaded);
}

function defineUnivariate() {
	Univariate = (function(Dashboard, $) {
